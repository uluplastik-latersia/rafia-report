  ...
  return (
    <div className="bg-gray-100 min-h-screen py-8 print:py-0 print:bg-white text-black font-sans">
      ...
      <div className="max-w-4xl mx-auto bg-white shadow-2xl print:shadow-none print:w-full px-12 py-16 print:p-0 min-h-[29.7cm]">
        ...
        {/* TABEL DATA */}
        <table className="w-full text-xs text-left border-collapse mb-10 border border-gray-400">
          <thead>
            <tr className="bg-gray-100 text-black border-y border-gray-400">
              <th className="py-3 px-2 border-r border-gray-400 text-center w-[50px]">No</th>
              <th className="py-3 px-2 border-r border-gray-400 w-[100px]">Tgl Shift</th>
        ...
        {/* BAGIAN TANDA TANGAN */}
        <div className="flex justify-between w-full px-12 mt-16 pt-8 pb-4 break-inside-avoid">
          <div className="text-center">
            <p className="text-sm font-semibold mb-20 text-gray-600">Dibuat Oleh,</p>
            <div className="w-40 border-b border-black"></div>
            <p className="text-xs font-bold mt-2 uppercase">Admin / Operator</p>
          </div>
          <div className="text-center">
            <p className="text-sm font-semibold mb-20 text-gray-600">Mengetahui,</p>
            <div className="w-40 border-b border-black"></div>
            <p className="text-xs font-bold mt-2 uppercase">Manager / Direktur</p>
          </div>
        </div>
